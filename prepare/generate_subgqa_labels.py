...
'''Novel test phase'''
'''----------------'''
# TBD to random generate 600 tasks  2-cls comb
novel_test_classes_in_exp = np.array([[15, 12], [1, 14], [10, 8], [3, 13], [0, 6], [4, 19], [9, 5], [16, 7], [11, 17], [18, 2]]) + 20
...
if mode in ['train', 'non_novel_test']:
    ...
    inds_classes = [[np.where(ytrain==cl)] for cl in np.arange(train_num_class, num_class)]     # 20-39

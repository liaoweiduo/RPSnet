...
def _get_obj365_datasets(
    ...
    """
    Create Objects365 dataset, with given json files,
    containing instance tuples with shape (img_name, label).

    Note that: This benchmark do not have sub subset.
    ...
    :param seed: A valid int used to initialize the random number generator.
        Can be None.
    :param mode: Option [continual, sys, pro, non, noc].    # No , sub
    ...
    if mode == 'continual':
        ...
        # img_info:
        # {"image_id": 900316, "label": ["Glasses", "Person"], "imageName": "patch16/objects365_v2_00900316.jpg"}
...
if __name__ == "__main__":
    ...
    # fixed_class_order:
    # [[('Bracelet', 'Person'), ('Lamp', 'Person')],
    #  [('Boat', 'Sailboat'), ('Other Shoes', 'Person')],
    #  [('Microphone', 'Person'), ('Car', 'SUV')],
    #  [('Car', 'Person'), ('Bench', 'Person')],
    #  [('Flag', 'Person'), ('Person', 'Street Lights')],
    #  [('Person', 'Sneakers'), ('Handbag/Satchel', 'Person')],
    #  [('Glasses', 'Person'), ('Flower', 'Vase')],
    #  [('Chair', 'Person'), ('Boat', 'Person')],
    ...
    _benchmark_instance = fewshot_testing_benchmark(
        n_experiences=300, n_way=10, n_shot=10, n_query=10, mode='pro',
        task_offset=10,
